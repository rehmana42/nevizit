...
const HotelRestaurant = () => {
  ...
  const [selectedType, setSelectedType] = useState('tourist_attraction'); // Default filter type
              ...
              <div className="flex flex-col space-y-4">
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    checked={selectedType === 'tourist_attraction'}
                    onChange={handleFilterChange}
                    className="w-6 h-6"
                  />
                  <span className="text-lg">Tourist Places</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="radio"
                    value="lodging"
                    checked={selectedType === 'lodging'}
                    onChange={handleFilterChange}
                    className="w-6 h-6"
                  />
